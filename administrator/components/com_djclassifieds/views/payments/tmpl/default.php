		...
		<div id="filter-bar" class="btn-toolbar">
			...
			<div class="btn-group pull-right hidden-phone">
				<select name="filter_published" class="inputbox" onchange="this.form.submit()">
					...
					<?php echo JHtml::_('select.options', array(JHtml::_('select.option', '0', 'COM_DJCLASSIFIEDS_ADVERT'),JHtml::_('select.option', '1', 'COM_DJCLASSIFIEDS_POINTS_PACKAGES'),JHtml::_('select.option', '2', 'COM_DJCLASSIFIEDS_PROMOTION_MOVE_TO_TOP'),JHtml::_('select.option', '3', 'COM_DJCLASSIFIEDS_SUBSCRIPTION_PLANS')), 'value', 'text', $this->state->get('filter.type'), true);?>
				</select>
			</div>						
		</div>
	<div class="clr"> </div>
